    ...
    for field in spec.parsed_fields():
        ...
        if (container_gets_allocator and takes_allocator(field.base_type)):
            ...
            if (field.base_type == "string"):
                ...
                (cpp_msg_unqualified, cpp_msg_with_alloc, _) = cpp_message_declarations(cpp_name_prefix,
                                                                                        field.base_type)
...
def write_constant_definition(s, spec, constant):
    ...
    if (constant.type not in ['byte', 'int8', 'int16', 'int32', 'int64', 'char', 'uint8', 'uint16', 'uint32', 'uint64',
                              'string']):
